...
class Zend_Controller_Front
{
    ...
    {
        GF::zfdebug_mark('ZF::Start Dispatch');
         ...
         * Initialize router
         */
        GF::zfdebug_mark('ZF::Init router code');
        ...
        try {
            ...
            */
            ...
            try {
                GF::zfdebug_mark('ZF::Call router routine');
            ...
            */
             ...
             */
            GF::zfdebug_mark('ZF::Attempt dispatch');
            do {
        ...
        if ($this->returnResponse()) {
            GF::zfdebug_mark('ZF::Return response');
            return $this->_response;
        }

        GF::zfdebug_mark('ZF::Send response');
